...
context "the computer player" do
  describe "#opposite_corner_strategy?" do
    it "returns true when human player is using an opposite corner strategy" do
      ...
      expect(bot.opposite_corner_strategy?(board.spaces)).to be true
      board.spaces = [
                       "X", "1", "2",
                       "3", "O", "5",
                       "X", "7", "8"
      ...
      expect(bot.opposite_corner_strategy?(board.spaces)).to be false
    end
  end

  # describe "#counter_opposite_corner_strategy" do
  #   it "prevents the human player from making two possible wins using a oppsite corner strategy" do
  #     board = Board.new
  #     bot = Bot.new
  #     bot.piece = "O"
